...
?>
	...
	<div id="man-1" style="top:5px; width:520px;right:10px;">
		<div id="conf">
				&nbsp;
		</div>
		<span id="ms">Election Report</span>
		...
		?>
				<div style='clear:both;'>
					<div style='float:left;font-size:11px;width:60px;height:50px;margin-left:0px;line-height:15px;'>
						<?php echo $r['candidate_name']; ?>
					</div>
					<div style='float:left;font-size:11px;width:60px;height:50px;margin-left:20px;line-height:15px;'>
						<?php echo "<img src='candidates/".$r['candidate_image']."' width='50' height='40' />"; ?>
					</div>
					<div style='float:left;font-size:11px;width:120px;height:50px;margin-left:20px;line-height:15px;'>
						<?php 
		...
		?>
		No Candidate registered yet!<br />
		<?php
			}//end of else
		?>
